...
import { PointerLockControls } from 'three/examples/jsm/controls/PointerLockControls.js'; // Esta ruta es externa, no necesita cambio.
...
// ====== LUCES ======
export const pointLight = new THREE.PointLight(0xffffff, 2.5, 10000); // Ajustamos intensidad y distancia
pointLight.castShadow = true;
pointLight.shadow.mapSize.width = 1024; // calidad/ram balanceada
pointLight.shadow.mapSize.height = 1024;
pointLight.shadow.camera.near = 0.1; // Aseguramos que las sombras cercanas también se calculen
pointLight.shadow.camera.far = 1000; // Aumentamos la distancia para que las sombras se proyecten en todo el sistema solar
